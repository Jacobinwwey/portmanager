...
Updated: 2026-04-17
Version: v0.3.5-m2-confidence-history-sync
...
- `下一主线`：继续在同一条 live host / rule / policy 切片上推进 Milestone 2 的 confidence-readiness 维护：复核同步后的 summary、保持 qualified history 持续转绿，并且只在证据足够时收窄里程碑文案。
