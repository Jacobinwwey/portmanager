...
- [ ] Next lane: harden Milestone 2 reliability on the same live slice with repeated proof and real GitHub backup delivery.
...
- [ ] 下一主线：继续在同一条 live 切片上加固 Milestone 2 可靠性，重点放在重复证明，以及 GitHub backup 真正交付。
