...
const reviewChecklist = computed(() => props.locale === 'zh'
  ...
  : progress.readiness.status === 'promotion-ready'
    ? [
        ...
        'If bounded Debian 12 rehearsal is the next blocker, run `pnpm milestone:rehearse:debian12-incus -- --name portmanager-debian12-review` so the disposable staging lane and next commands stay repo-native.',
...
const currentDirectionSummary = computed(() => props.locale === 'zh'
  ? progress.readiness.status === 'promotion-ready'
    ? [
        ...
        '当前收尾覆盖图也已经落地：`docs/brainstorms/2026-04-27-portmanager-m2-closeout-incus-runway-requirements.md` 与 `docs/plans/2026-04-27-portmanager-m2-closeout-incus-runway-plan.md` 现在把 repo-native `pnpm milestone:rehearse:debian12-incus -- --name portmanager-debian12-review` helper、Web overview runway 与 development-progress runway 同步固定下来。'
      ]
    : [
  ...
  : progress.readiness.status === 'promotion-ready'
    ? [
        ...
        'The closeout overlay is now landed too: `docs/brainstorms/2026-04-27-portmanager-m2-closeout-incus-runway-requirements.md` and `docs/plans/2026-04-27-portmanager-m2-closeout-incus-runway-plan.md` now freeze repo-native `pnpm milestone:rehearse:debian12-incus -- --name portmanager-debian12-review`, the Web overview runway, and the development-progress runway in one reviewable slice.'
      ]
    : [
...
const currentDirectionDocs = computed(() => [
  {
    href: githubSourceLink('docs/brainstorms/2026-04-27-portmanager-m2-closeout-incus-runway-requirements.md'),
    label: copy.value.currentDirectionRequirementsLink
  },
  {
    href: githubSourceLink('docs/plans/2026-04-27-portmanager-m2-closeout-incus-runway-plan.md'),
