  ...
  buckets: [
    {
      ...
      items: {
        en: [
          ...
          'The latest promotion-ready refresh on 2026-04-21 republished the tracked snapshot from synced run `24699564258/1`; exact live counts and the latest qualified mainline run now belong to the live confidence card and tracked confidence artifact rather than brittle roadmap prose.',
        ...
        zh: [
          ...
          '`2026-04-21` 的最新 promotion-ready refresh 已把公开快照重发到同步后的 `24699564258/1` 证据；精确实时计数与最新 qualified mainline run 现在统一以下方 live confidence 卡片和被跟踪 confidence artifact 为准，而不再继续依赖易漂移的 roadmap 文案。' ,
