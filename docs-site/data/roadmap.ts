  ...
  buckets: [
    {
      ...
      items: {
        en: [
          ...
          'The active implementation map now lives in `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`: guide coverage is complete, Units 63 through 69 are landed, and the next bounded queue is now second-target review adjudication plus any review-found delta while the locked target-profile registry, consumer-boundary decision pack, deployment-boundary decision pack, second-target policy pack, persistence decision pack, and Debian review-prep governance docs stay the truthful platform contract.',
        ...
        zh: [
          ...
          '当前激活的实现地图已经切到 `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`：guide coverage 已完整、Unit 63 到 Unit 69 已落地，而下一条有边界队列现在收窄为 second-target review adjudication 与任何 review-found delta，同时继续让锁定 target-profile registry、consumer-boundary decision pack、deployment-boundary decision pack、second-target policy pack、persistence decision pack 与 Debian review-prep 治理文档保持为稳定平台契约。',
...
export const roadmapMilestones: RoadmapMilestone[] = [
  ...
  },
  {
    ...
    developerFocus: {
      en: [
        'Use `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md` as the active implementation map; Units 51 through 69 are landed on that path, review-packet readiness still makes guide coverage plus artifact coverage explicit, and Units 64 through 69 now preserve one bounded review packet at `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/` with artifact coverage `20/20`.',
