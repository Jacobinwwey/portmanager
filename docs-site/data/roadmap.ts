  ...
  buckets: [
    {
      ...
      items: {
        en: [
          ...
          'The active implementation map now lives in `docs/brainstorms/2026-04-21-portmanager-m3-review-adjudication-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-adjudication-plan.md`: guide coverage is complete, Units 63 through 69 are landed, `/second-target-policy-pack` now reports `review_open`, and the next bounded queue is second-target review adjudication plus any review-found delta while the locked target-profile registry, consumer-boundary decision pack, deployment-boundary decision pack, second-target policy pack, persistence decision pack, and Debian review-prep governance docs stay the truthful platform contract.',
        ...
        zh: [
          ...
          '当前激活的实现地图已经切到 `docs/brainstorms/2026-04-21-portmanager-m3-review-adjudication-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-adjudication-plan.md`：guide coverage 已完整、Unit 63 到 Unit 69 已落地，`/second-target-policy-pack` 现在还会公开 `review_open`，而下一条有边界队列现在收窄为 second-target review adjudication 与任何 review-found delta，同时继续让锁定 target-profile registry、consumer-boundary decision pack、deployment-boundary decision pack、second-target policy pack、persistence decision pack 与 Debian review-prep 治理文档保持为稳定平台契约。',
    ...
    },
    {
      ...
      items: {
        ...
        zh: [
          ...
          '索引化 event/audit review、显式 audit-review owner、target-profile registry 发布、persistence-readiness reporting、新的 `/persistence-decision-pack`、`/consumer-boundary-decision-pack` 与 `/deployment-boundary-decision-pack` 复核表面，以及兼容旧路由的 `/api/controller` consumer boundary 现在都已经落地，Debian review-prep 文档也已经冻结文案契约、验收 recipe、review-packet template、bootstrap proof 指南 `docs/operations/portmanager-debian-12-bootstrap-proof-capture.md`、steady-state 指南 `docs/operations/portmanager-debian-12-steady-state-proof-capture.md`、backup-restore 指南 `docs/operations/portmanager-debian-12-backup-restore-proof-capture.md`、diagnostics 指南 `docs/operations/portmanager-debian-12-diagnostics-proof-capture.md`、rollback 指南 `docs/operations/portmanager-debian-12-rollback-proof-capture.md` 与 operator ownership，而且有边界的 candidate host 注册/probe/bootstrap review-prep lane 也已经真实存在，所以剩余缺口收窄为围绕 `/second-target-policy-pack` 去裁定已保留的 Debian 12 packet，并处理仍然真实存在的 review-found delta。',
          'roadmap、里程碑文档、产品规格、架构文档与 root progress docs 现在都已经发布同一份 Milestone 3 gap map 与下一步 adjudication 方向。',
    ...
    },
    {
      ...
      items: {
        en: [
          ...
          'Use the active requirements/plan pair as the current implementation map: `docs/brainstorms/2026-04-21-portmanager-m3-review-adjudication-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-adjudication-plan.md`.',
          'Units 51 through 69 are now landed on that map; review-packet readiness still makes guide coverage and artifact coverage explicit, the earlier Units 63 through 69 queue now has one bounded review packet preserved at `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`, and artifact coverage is now `20/20`.',
          'Move next through bounded second-target review adjudication for declared candidate `debian-12-systemd-tailscale` under `/second-target-policy-pack`, plus only the review-found deltas that remain real, instead of reopening already-landed seams or pretending standalone deployment pressure already exists.',
        ...
        zh: [
          ...
          '把当前激活的 requirements/plan 组合作为实现地图：`docs/brainstorms/2026-04-21-portmanager-m3-review-adjudication-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-adjudication-plan.md`。',
          'Unit 51 到 Unit 69 现在都已落地；review-packet readiness 继续把 guide coverage 与 artifact coverage 分开公开，此前公开的 Units 63 through 69 队列现在也已经拥有一份有边界 review packet：`docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`，而 artifact coverage 现在是 `20/20`。',
          '下一步转向有边界 second-target review adjudication：围绕已声明候选 `debian-12-systemd-tailscale` 继续执行 review，并且只处理仍然真实存在的 review-found delta，而不是重新打开已经落地的 seam，或假装独立部署压力已经真实出现。',
...
export const roadmapMilestones: RoadmapMilestone[] = [
  ...
  },
  {
    ...
    developerFocus: {
      en: [
        'Use `docs/brainstorms/2026-04-21-portmanager-m3-review-adjudication-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-adjudication-plan.md` as the active implementation map; Units 51 through 69 are landed on that path, review-packet readiness still makes guide coverage plus artifact coverage explicit, and `/second-target-policy-pack` now also publishes `review_open` plus pending adjudication verdicts on the preserved bounded review packet at `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`.',
        'Move next through bounded second-target review adjudication for declared candidate `debian-12-systemd-tailscale` under `/second-target-policy-pack`, plus only review-found deltas, instead of reopening routing split, replay ownership, or already-landed target-profile and decision-pack seams.',
      ...
      zh: [
        '把 `docs/brainstorms/2026-04-21-portmanager-m3-review-adjudication-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-adjudication-plan.md` 当作当前实现地图；其中 Unit 51 到 Unit 69 已经全部落地，review-packet readiness 已把 guide coverage 与 artifact coverage 显式公开，而且 `/second-target-policy-pack` 现在还会针对 `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/` 这份有边界 review packet 公开 `review_open` 与待裁定 verdict。',
        '下一步转向有边界 second-target review adjudication：围绕已声明候选 `debian-12-systemd-tailscale` 继续执行 review，并且只处理仍然真实存在的 review-found delta，而不是重新把 controller transport 堆回去、重做 routing split、重做 replay owner，或重复补已经落地的 target-profile 与 decision pack seam。',
