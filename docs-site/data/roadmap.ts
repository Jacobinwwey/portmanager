  ...
  buckets: [
    {
      ...
      items: {
        en: [
          ...
          'Unit 63 review-packet readiness is now real, and Units 64 plus 65 now advance that earlier Units 63 through 69 queue: `/second-target-policy-pack` still shows guide coverage `6/6`, artifact coverage is now `8/20`, bootstrap plus steady-state parity are landed, and one bounded Debian 12 review packet is preserved at `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/` with bootstrap and steady-state summaries so docs presence cannot masquerade as parity proof.',
          'The active implementation map now lives in `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`: guide coverage is complete, Units 63 through 65 are landed, and the remaining Units 66 through 69 now define the bounded Debian 12 packet-execution and closeout queue while the locked target-profile registry, consumer-boundary decision pack, deployment-boundary decision pack, second-target policy pack, persistence decision pack, and Debian review-prep governance docs stay the truthful platform contract.',
        ...
        zh: [
          ...
          'Unit 63 review-packet readiness 现在也已真实存在，而 Unit 64 与 Unit 65 现在又把此前公开的 Units 63 through 69 队列继续向前推进：`/second-target-policy-pack` 继续公开 review-packet readiness、guide coverage `6/6`，artifact coverage 现在来到 `8/20`，bootstrap 与 steady-state parity 都已落地，并且已经把一份有边界 Debian 12 review packet 保留到 `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`，其中带有 bootstrap 与 steady-state summary，避免把“指南文件已存在”误写成“等价证明已完成”。',
          '当前激活的实现地图已经切到 `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`：guide coverage 已完整、Unit 63 到 Unit 65 已落地，而剩余 Unit 66 到 Unit 69 现在明确限定 Debian 12 review packet 的执行与 closeout 队列，同时继续让锁定 target-profile registry、consumer-boundary decision pack、deployment-boundary decision pack、second-target policy pack、persistence decision pack 与 Debian review-prep 治理文档保持为稳定平台契约。',
    ...
    },
    {
      ...
      items: {
        en: [
          ...
          'Use the active requirements/plan pair as the current implementation map: `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`.',
          'Units 51 through 65 are now landed on that map; review-packet readiness still makes guide coverage and artifact coverage explicit, the earlier Units 63 through 69 queue now has one bounded review packet preserved at `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`, and artifact coverage is now `8/20`.',
          'Move next through Units 66 through 69: backup-and-restore packet execution, diagnostics packet execution, rollback packet execution, and second-target review closeout for declared candidate `debian-12-systemd-tailscale` under `/second-target-policy-pack` instead of reopening already-landed seams or pretending standalone deployment pressure already exists.',
        ...
        zh: [
          ...
          '把当前激活的 requirements/plan 组合作为实现地图：`docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`。',
          'Unit 51 到 Unit 65 现在都已落地；review-packet readiness 继续把 guide coverage 与 artifact coverage 分开公开，此前公开的 Units 63 through 69 队列现在也已经拥有一份有边界 review packet：`docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`，而 artifact coverage 现在是 `8/20`。',
          '下一步转向 Unit 66 到 Unit 69：为已声明候选 `debian-12-systemd-tailscale` 依次执行 backup-and-restore packet、diagnostics packet、rollback packet 与 second-target review closeout，而不是重新打开已经落地的 seam，或假装独立部署压力已经真实出现。',
...
export const roadmapMilestones: RoadmapMilestone[] = [
  ...
  },
  {
    ...
    developerFocus: {
      en: [
        'Use `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md` as the active implementation map; Units 51 through 65 are landed on that path, review-packet readiness still makes guide coverage plus artifact coverage explicit, and Units 64 plus 65 now preserve one bounded review packet at `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/` with artifact coverage `8/20`.',
        'Move next through Units 66 through 69: backup-and-restore packet execution, diagnostics packet execution, rollback packet execution, and second-target review closeout for declared candidate `debian-12-systemd-tailscale` under `/second-target-policy-pack` instead of reopening routing split, replay ownership, or already-landed target-profile and decision-pack seams.',
      ...
      zh: [
        '把 `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md` 当作当前实现地图；其中 Unit 51 到 Unit 65 已经全部落地，review-packet readiness 已把 guide coverage 与 artifact coverage 显式公开，而且 Unit 64 与 Unit 65 现在也已经把一份有边界 review packet 保留到 `docs/operations/artifacts/debian-12-bootstrap-packet-2026-04-21/`，artifact coverage 现为 `8/20`。',
        '下一步转向 Unit 66 到 Unit 69：围绕已声明候选 `debian-12-systemd-tailscale` 依次执行 backup-and-restore packet、diagnostics packet、rollback packet 与 second-target review closeout，而不是重新把 controller transport 堆回去、重做 routing split、重做 replay owner，或重复补已经落地的 target-profile 与 decision pack seam。',
