  ...
  buckets: [
    {
      ...
      items: {
        en: [
          ...
          'Unit 63 review-packet readiness is now real: `/second-target-policy-pack` publishes review-packet readiness, guide coverage `6/6`, artifact coverage `0/20`, and the bounded Units 63 through 69 queue so docs presence cannot masquerade as parity proof.',
          'The active implementation map now lives in `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`: guide coverage is complete, artifact coverage is still missing, Unit 63 is landed, and Units 64 through 69 now define the bounded Debian 12 packet-execution and closeout queue while the locked target-profile registry, consumer-boundary decision pack, deployment-boundary decision pack, second-target policy pack, persistence decision pack, and Debian review-prep governance docs stay the truthful platform contract.',
        ...
        zh: [
          ...
          'Unit 63 review-packet readiness 现在也已真实存在：`/second-target-policy-pack` 会公开 review-packet readiness、guide coverage `6/6`、artifact coverage `0/20` 与 Units 63 through 69 队列，避免把“指南文件已存在”误写成“等价证明已完成”。',
          '当前激活的实现地图已经切到 `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md`：guide coverage 已完整、artifact coverage 仍缺失、Unit 63 已落地，而 Unit 64 到 Unit 69 现在明确限定 Debian 12 review packet 的执行与 closeout 队列，同时继续让锁定 target-profile registry、consumer-boundary decision pack、deployment-boundary decision pack、second-target policy pack、persistence decision pack 与 Debian review-prep 治理文档保持为稳定平台契约。',
    ...
    },
    {
      ...
      items: {
        en: [
          ...
          'Units 51 through 63 are now landed on that map; review-packet readiness now makes guide coverage and artifact coverage explicit, and Units 63 through 69 publish the bounded post-guide queue.',
          'Move next through Units 64 through 69: bootstrap packet execution, steady-state packet execution, backup-and-restore packet execution, diagnostics packet execution, rollback packet execution, and second-target review closeout for declared candidate `debian-12-systemd-tailscale` under `/second-target-policy-pack` instead of reopening already-landed seams or pretending standalone deployment pressure already exists.',
        ...
        zh: [
          ...
          'Unit 51 到 Unit 63 现在都已落地；review-packet readiness 已把 guide coverage 与 artifact coverage 分开公开，而 Units 63 through 69 也已经发布后续有边界队列。',
          '下一步转向 Unit 64 到 Unit 69：为已声明候选 `debian-12-systemd-tailscale` 依次执行 bootstrap packet、steady-state packet、backup-and-restore packet、diagnostics packet、rollback packet 与 second-target review closeout，而不是重新打开已经落地的 seam，或假装独立部署压力已经真实出现。',
...
export const roadmapMilestones: RoadmapMilestone[] = [
  ...
  },
  {
    ...
    developerFocus: {
      en: [
        'Use `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` and `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md` as the active implementation map; Units 51 through 63 are landed on that path, and review-packet readiness now makes guide coverage plus artifact coverage explicit.',
        'Move next through Units 64 through 69: bootstrap packet execution, steady-state packet execution, backup-and-restore packet execution, diagnostics packet execution, rollback packet execution, and second-target review closeout for declared candidate `debian-12-systemd-tailscale` under `/second-target-policy-pack` instead of reopening routing split, replay ownership, or already-landed target-profile and decision-pack seams.',
      ...
      zh: [
        '把 `docs/brainstorms/2026-04-21-portmanager-m3-review-packet-readiness-requirements.md` 与 `docs/plans/2026-04-21-portmanager-m3-review-packet-readiness-plan.md` 当作当前实现地图；其中 Unit 51 到 Unit 63 已经全部落地，而且 review-packet readiness 已把 guide coverage 与 artifact coverage 显式公开。',
        '下一步转向 Unit 64 到 Unit 69：围绕已声明候选 `debian-12-systemd-tailscale` 依次执行 bootstrap packet、steady-state packet、backup-and-restore packet、diagnostics packet、rollback packet 与 second-target review closeout，而不是重新把 controller transport 堆回去、重做 routing split、重做 replay owner，或重复补已经落地的 target-profile 与 decision pack seam。',
