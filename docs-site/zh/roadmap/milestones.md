...
- 下一批队列：继续把已落地的 consumer boundary、audit-review boundary、target-profile registry 与 persistence decision pack 保持稳定，再定义更后置的独立 split criteria 与更广第二目标策略
